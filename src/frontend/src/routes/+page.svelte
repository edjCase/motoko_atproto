<script>
    ...
    function addService() {
        services = [...services, { id: "", type: "", endpoint: "" }];
    }
    ...
    async function verifyPlcDirectory() {
        if (!did) {
            verifyRequestResult =
                "Error: No DID available. Build request first.";
    ...
    <section class="initialize-section">
        ...
        {:else}
            ...
            <div class="initialize-instructions">
                ...
                <ol>
                    <li>
                        Use the PLC Directory Integration below to build a PLC
                        request
                    </li>
                    <li>
                        Submit the request to plc.directory using the generated
                        cURL command
                    </li>
            ...
            <form class="initialize-form">
                <div class="form-section">
                    ...
                    <div class="field-group">
                        ...
                        />
                        <small
                            >Enter your full domain name (e.g., pds.example.com)</small
                        >
                    </div>
                    ...
                    <div class="field-group">
                        ...
                        />
                        <small
                            >Enter the DID you received after submitting to
                            plc.directory</small
                        >
                    </div>

                    <div class="field-group">
                        <label for="init-contact-email"
                    ...
                    {#each services as service, index}
                        <div class="service-item">
                            <div class="service-fields">
                                <div class="field-group">
                                    <label for="service-id-{index}">Id:</label>
                                    <input
                                        id="service-id-{index}"
                                        type="text"
                                        bind:value={services[index].id}
                                        placeholder="Service id"
                                        class="text-input"
                                    />
                                </div>
                                <div class="field-group">
                                    <label for="service-type-{index}"
                                        >Type:</label
                                    >
                                    <input
                                ...
                                <div class="field-group">
                                    <label for="service-endpoint-{index}"
                                        >Endpoint:</label
                                    >
                                    <input
            ...
            <div class="request-data">
                ...
                <div class="curl-section">
                    ...
                    <div class="curl-container">
                        <pre
                            class="curl-command">curl -X POST https://plc.directory/{did} \
  -H "Content-Type: application/json" \
  -d '{rawJsonText}'</pre>
                    </div>
                </div>
